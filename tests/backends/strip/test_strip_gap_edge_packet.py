...
class TestStripGapEdgePacket:
    ...
    The 1-D reduction of the unified backend.
    """
    ...
    def test_packet_conserves_with_zero_subedge_leakage(self) -> None:
        ...
        # The state carries a uniform mesh, so the pitch is what the packet
        # is laid out against: the shape sits on the coordinates that pitch
        # implies.

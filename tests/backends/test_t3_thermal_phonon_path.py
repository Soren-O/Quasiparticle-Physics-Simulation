"""Tests for the use_thermal_phonons routing in T3DiffusionBackend.steady_state."""
...
def _build_state(T_bath: float = 0.3, num_energy: int = 20) -> T3DiffusionState:

...
[Kopnin's Eqs.~(10.69)--(10.71)], with \(\nu(0)\) the normal-state
density of states at the Fermi level, fixing the sign independent of the
...
This work is relevant because recent
superconducting resonator and qubit treatments are usually spatially
homogeneous \cite{goldie2013,catelani2019,fischer2023,fischer2024,marchegiani2025} or zero-dimensional in their kinetics. Spatial simulations of
...
finite \(\ii\Gamma\) directly into the spectral functions changes the clean BCS
...
(\cref{eq:projection_average_commutator}), and their scalar end points
...
DOS-gradient drift for an inhomogeneous gap. The remaining theoretical

...
\(E\to E+\ii0^{+}\) of \cref{eq:bcs_gf_components}.)
...
\(f(E,\hat\bp)\) from \(\check g\), and \(\avg{\cdot}_{\hat\bp}\) is the
...
\begin{figure}[t]
  ...
  \cref{eq:scalar_BC_energy} (dimensionless \(G_N=0.1\) in diffusion
  units), shown at a fixed energy

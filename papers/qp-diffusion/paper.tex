...
\(\mathcal D_L\) and \(\DOS\) with the lifetime broadening introduced below \cref{eq:bcs_dos}; the moving-bin weak formulation of
...
directly. Such a moving-\(\xi\) / branch-covariant reformulation is, however, a matter of
...
population [integrating \cref{eq:cons_form} over energy for a
shape-preserving profile gives
\(D_{\mathrm{eff}}=\DN\!\int\!f\,\dd E\big/\!\int\!\DOS f\,\dd E\), the
\(\DOS f\)-weighted average of \(\DN/\DOS\)]: near-gap quasiparticles, which dominate the thermal population

...
We additionally derive the common-phase, above-gap scalar Kupriyanov--Lukichev
...
A separate branch of the literature already carries the operator in the
form derived below: the dirty-limit kinetic-equation treatments of
superconducting single-photon detectors. Eq.~(1) of
...
our \(N_2\). For a real BCS gap its spectral functions give
...
question is not posed, and in the calculations reported both the gradient
term and the \(\partial_t|\Delta|\) term are switched off.
...
This paper derives the correct choice of diffusion operator (the placement of the spectral weight relative to the divergence) by both
...
dressing to the transverse channel, the taxonomy of alternative placements
and the drift they carry, and the scalar interface condition. 

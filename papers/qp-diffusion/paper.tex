...
Both routes are organized around the angular
harmonics of the distribution amplitudes, i.e.\ their dependence on the
...
\end{equation}
for a generic amplitude \(X\). The isotropic
...
against collisions rather than evolved (similar to the derivation of
Fick's law from the normal-metal Boltzmann equation). 
A further classification of the harmonics, by parity under the inversion \(\hat{\bp}\to-\hat{\bp}\) (even vs.\ odd),
will be useful below.


\subsection{Quasiparticle Boltzmann-Like Equations}
By an exact change of basis we can recast the coupled two-mode pair \cref{eq:beta_twomode_L,eq:beta_twomode_T} into a \emph{single} scalar Boltzmann-like equation for the occupation of

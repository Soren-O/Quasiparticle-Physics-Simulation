...
main-text~\cref{M-eq:antipodal_average_identity}. The representational
...
the sector assumptions collected at the end of the main-text introduction
apply),
\begin{equation}
  \partial_t f
...
main-text~\cref{M-eq:antipodal_average_identity}. That relabelling acts on
...
order,
\begin{equation}
  \tfrac14\Tr\big[\tau_1\,\ii[L_0,\hat g^K]_\star\big]\Big|_{O(\hbar)}=0,

...
register(
    Benchmark(
        ...
        caveat=(
            ...
            "0), 0-D in space. The single-cell backend's own copy of this update "
            ...
            "the benchmark drives the spatial core on a 1×1 mask, the route the "
            "kinetics time march runs and the one that publishes the phonon "
            "arrays it scores.\n"

...
register(
    Benchmark(
        ...
        convergence=(
            ...
            "timed on the single-cell path). The alternative, N_E=64 "
            "(28 ladders), costs 3.6-3.9 s "
        ...
        caveat=(
            ...
            "Those numbers were taken at the patch point qpsim.backends."
            "diffusion.sub_gap_photon_collision_rates. This case reaches the "
            "same kernel through qpsim.collisions.spatial."
            ...
            "qpsim/backends/spatial.py are now the covered path, where "

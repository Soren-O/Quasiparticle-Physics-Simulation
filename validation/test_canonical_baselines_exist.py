...
LIVE_CANONICAL_ARTIFACTS = (
    "constant/f24_fig8_xqp_pb.csv",
    "constant/f24_fig8_xqp_pb.pdf",
    "constant/f24_figs_5_7_fe_pb.csv",
    "constant/f24_figs_5_7_fe_pb.pdf",
    "constant/fischer2024_fig5_qpsim_native.csv",
    "constant/fischer2024_fig5_qpsim_native.pdf",
    "constant/fischer2024_fig8_qpsim_native.csv",
    "constant/fischer2024_fig8_qpsim_native.pdf",
    "constant/fischer_fig3_paper.csv",
    "constant/fischer_fig3_paper.pdf",
    "constant/fischer_fig3_paper.validation.json",
    "constant/fischer_fig5_paper.campaign.json",
    "constant/fischer_fig5_paper.csv",
    "constant/fischer_fig5_paper.promotion.json",
    "constant/fischer_fig5_paper_a.pdf",
    "constant/fischer_fig5_paper_b.pdf",
    "constant/fischer_fig7_paper.csv",
    "constant/fischer_fig7_paper.pdf",
    "constant/fischer_fig7_paper.promotion.json",
    "kaplan/fischer_fig6_paper.csv",
    "kaplan/fischer_fig6_paper.pdf",
    "kaplan/fischer_fig6_paper.promotion.json",
...
QUARANTINED_ARCHIVES = (
    "constant/fischer_figs_9_13_qi_vs_pread.csv",
    "constant/fischer_figs_9_13_qi_vs_pread.pdf",
)

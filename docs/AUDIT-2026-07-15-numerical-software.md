...
| Fischer 2024 promoted artifact hashes | Canonical CSV/PDF SHA-256: Fig. 5 paper topology `691569ff69fe17897792c1e14a1c4bee34e81cf5eb9c53f29756aa05b162c1ea` / `8a11a07739a770dd784cbaececbcf8911cff8ca249428ce507cab8e64e0fd46`; Fig. 8 paper topology `6a834ed3a74e035a2755c616b8341c98d5553a7437a7bc55810decdaa207b3bf` / `3e89910af8777541f88bdd71c5308c170dc3e17764052b2eda013690ca3dfd12`; Fig. 8 native `537b574ac480ee54872ef1f331e7c169463b94d6f93ddfbeecca2beb8b7c6b42` / `8636d8d9dd0d4900e1481de02187d177c6bb42d68af62e29769d309a7b0354c1`; Figs. 5--7 native `649a57b0c4afb159a62a56c9103c6d35b18ad976f45a8c5292547e1bbd0c83b2` / `069aa4f61e9d36ba6ac0ea0eb35d26c115ad79869948a6d7261d501e370d59f9`. The 84 persisted solve points all passed strict schema, dependency-hash, ordered-certificate, and certified-payload readback. Maximum `(QP backward error, residual)` by family was `(1.13e-7, 1.10e-16)`, `(9.10e-7, 5.92e-13)`, `(2.72e-11, 3.29e-15)`, and `(3.39e-13, 7.45e-17)`, respectively. A provenance-only LF/CRLF portability rebind changed the CSV hashes but preserved every table row, ordered certificate, certified-payload hash, and PDF byte-for-byte. |
...
- `python -m pytest --collect-only -q -m "slow and not manual_slow"`: 16/1516
  selected, 1500 deselected in 3.83 s;
- `python -m pytest --collect-only -q -m manual_slow`: one of 1516 selected,
  1515 deselected in 3.62 s.
...
| `transient/test_photon_kick_response.py::test_matches_pinned_baseline` | module `slow` | Direct pass in the four-node shared-fixture run |
...
Thus no numerical source patch is justified. The ideal clean-BCS,
...
1. retain the green 1499-pass default aggregate and final Ruff, mypy, compile,

...
Location: `qpsim/backends/t3_spatial_1d.py:600` [now `qpsim/backends/spatial.py:450-457,505` (`_interface_overrides`) with face composition at `qpsim/transport/spatial_operator.py:164-165`; the prepared patch names `_build_transport_operators`/`g_face`/`interface_weights`, which no longer exist — RE-DERIVE, DO NOT PASTE]
...
Location: `qpsim/backends/t3_spatial_1d.py:594` [RESOLVED BY THE REWRITE, pending physicist confirmation: `qpsim/backends/spatial.py:463` selects `"min" if state.diffusion_model.q == 0 else "harmonic"`, documented at `qpsim/transport/spatial_operator.py:149-156`]
...
Mirror the identical replacement at qpsim/backends/t3_spatial_1d.py:122-125 [that mirror is gone; the edit is now two sites: qpsim/physics/spectral.py:448-458 and the C3 score below] and at validation/fischer_2023/fig6_author_c3_score.py:620-628 in the SAME change (both outside packet P14).
```

...
| 3 | T3 reproduction regression against self-pinned baselines | Round-8 current-source F23 Figs. 3/5/6/7 plus hardened F24 and transient artifacts are complete. The M25 paper reproduction is retired; Figs. 9--13 remain quarantined. None of these self-pins establishes paper parity. |
...
`validation/baselines/{ph0_constant, ph0_kaplan, transient}/` with regression

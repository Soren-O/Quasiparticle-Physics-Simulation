...
The final default repository aggregate is **1507 passed, 17 deselected, 4
warnings in 502.46 s** on Windows (`pytest -q`). The deselections are the opt-in
